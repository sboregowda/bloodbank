...
****************/
mysql_connect('localhost', 'parag', 'hello@parag') or trigger_error("Unable to connect to the database: " . mysql_error());
mysql_select_db('sys') or trigger_error("Unable to switch to the database: " . mysql_error());
